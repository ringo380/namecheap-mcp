...
export function registerDnsTools(server, getClient) {
    ...
    server.registerTool('set_dns_hosts', {
        ...
        inputSchema: {
            ...
            }).refine((r) => r.recordType !== 'MX' || r.mxPref !== undefined, { message: 'mxPref is required for MX records', path: ['mxPref'] })).describe('Complete list of DNS records to set. Replaces all existing records.'),
        },
